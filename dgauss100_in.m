...
%load('D:\PhD\Simulation Data\100incl\frim05_in09.mat');
load('D:\PhD\Simulation Data\frim05_in1.mat');
...
%       
        ...
        bh(i) = ch(2) + i0; %gaussian detected center value for each cut


        bhu(i)= bh(i);  %center value for each line
